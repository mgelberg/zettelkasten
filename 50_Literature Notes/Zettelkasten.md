...
https://zk.zettel.page/types-of-notes
### 1. Fleeting notes
...
- these notes are typically filed separately from your [permanent notes](https://zk.zettel.page/#3-permanent-notes), such as with your [Referencing](https://zk.zettel.page/referencing) system.
...
- remember, you are not simply collecting resources (see [Collecting Resources vs. Collecting Notes](https://zk.zettel.page/collecting))
...
- **[Linking](https://zk.zettel.page/linking)** is a key component of creating your Zettelkasten
...
- these are formal notes with certain qualities:
    - atomic (1 idea = 1 note) [1](https://zk.zettel.page/types-of-notes#fn1) - this encourages you to get to the core essence of the idea
    - write in full sentences and as if writing for someone else [2](https://zk.zettel.page/types-of-notes#fn2) - you shouldn’t need much context to understand the note, imagine reading it a year from now, will you still understand it?
